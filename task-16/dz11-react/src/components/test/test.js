            ...
            <div>
                <Card className="text-center">
                    ...
                    <div>
                        ...
                        <CardBody>
                            {this.data[this.state.questionIndex].type === 'input' ?
                                <InputQuestion item={this.data[this.state.questionIndex]} validateAnswer={this.validateAnswer}/> : null }
                            {this.data[this.state.questionIndex].type === 'checkbox' ?
                                <CheckboxQuestion item={this.data[this.state.questionIndex]} validateAnswer={this.validateAnswer}/> : null }
                            {this.data[this.state.questionIndex].type === 'radio' ?
                                <RadioQuestion item={this.data[this.state.questionIndex]} validateAnswer={this.validateAnswer}/> : null }
                        </CardBody>
                    </div> : 
                    <div>
